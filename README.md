...
<!-- rules-stats-start -->
![Rules Count](https://img.shields.io/badge/Rules-2%2C292%2C727-blue)
![Allowlist Count](https://img.shields.io/badge/Allowlist-354-green)

_This combined list was last compiled on **Jul 5, 2026 (UTC)** and contains **2,292,727** active blocking rules and **354** whitelist exceptions._
<!-- rules-stats-end -->
