...
<!-- rules-stats-start -->
![Rules Count](https://img.shields.io/badge/Rules-2%2C787%2C807-blue)
![Allowlist Count](https://img.shields.io/badge/Allowlist-354-green)

_This combined list was last compiled on **Jul 16, 2026 (UTC)** and contains **2,787,807** active blocking rules and **354** whitelist exceptions._
<!-- rules-stats-end -->
