...
<!-- rules-stats-start -->
![Rules Count](https://img.shields.io/badge/Rules-2%2C138%2C061-blue)
![Allowlist Count](https://img.shields.io/badge/Allowlist-353-green)

_This combined list was last compiled on **Jun 11, 2026 (UTC)** and contains **2,138,061** active blocking rules and **353** whitelist exceptions._
<!-- rules-stats-end -->
