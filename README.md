...
<!-- rules-stats-start -->
![Rules Count](https://img.shields.io/badge/Rules-2%2C263%2C276-blue)
![Allowlist Count](https://img.shields.io/badge/Allowlist-354-green)

_This combined list was last compiled on **Jul 2, 2026 (UTC)** and contains **2,263,276** active blocking rules and **354** whitelist exceptions._
<!-- rules-stats-end -->
