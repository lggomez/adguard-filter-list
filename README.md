...
<!-- rules-stats-start -->
![Rules Count](https://img.shields.io/badge/Rules-3%2C065%2C509-blue)
![Allowlist Count](https://img.shields.io/badge/Allowlist-360-green)

_This combined list was last compiled on **Sep 16, 2026 (UTC)** and contains **3,065,509** active blocking rules and **360** whitelist exceptions._
<!-- rules-stats-end -->
