...
<!-- rules-stats-start -->
![Rules Count](https://img.shields.io/badge/Rules-1%2C985%2C127-blue)
![Allowlist Count](https://img.shields.io/badge/Allowlist-353-green)

_This combined list was last compiled on **Jun 10, 2026 (UTC)** and contains **1,985,127** active blocking rules and **353** whitelist exceptions._
<!-- rules-stats-end -->
