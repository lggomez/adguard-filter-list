...
<!-- rules-stats-start -->
![Rules Count](https://img.shields.io/badge/Rules-2%2C891%2C229-blue)
![Allowlist Count](https://img.shields.io/badge/Allowlist-355-green)

_This combined list was last compiled on **Aug 8, 2026 (UTC)** and contains **2,891,229** active blocking rules and **355** whitelist exceptions._
<!-- rules-stats-end -->
