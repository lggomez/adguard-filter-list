...
<!-- rules-stats-start -->
![Rules Count](https://img.shields.io/badge/Rules-2%2C096%2C565-blue)
![Allowlist Count](https://img.shields.io/badge/Allowlist-353-green)

_This combined list was last compiled on **Jun 15, 2026 (UTC)** and contains **2,096,565** active blocking rules and **353** whitelist exceptions._
<!-- rules-stats-end -->
