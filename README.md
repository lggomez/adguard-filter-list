...
<!-- rules-stats-start -->
![Rules Count](https://img.shields.io/badge/Rules-2%2C795%2C133-blue)
![Allowlist Count](https://img.shields.io/badge/Allowlist-354-green)

_This combined list was last compiled on **Aug 1, 2026 (UTC)** and contains **2,795,133** active blocking rules and **354** whitelist exceptions._
<!-- rules-stats-end -->
