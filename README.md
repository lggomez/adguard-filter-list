...
<!-- rules-stats-start -->
![Rules Count](https://img.shields.io/badge/Rules-2%2C267%2C969-blue)
![Allowlist Count](https://img.shields.io/badge/Allowlist-354-green)

_This combined list was last compiled on **Jul 1, 2026 (UTC)** and contains **2,267,969** active blocking rules and **354** whitelist exceptions._
<!-- rules-stats-end -->
